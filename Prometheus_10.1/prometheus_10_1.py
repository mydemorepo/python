...
class Database:
    ...
    def set_connected_to_database(self, connection_state):
        print("Неможливо змінити значення" +
              " connected_to_database за допомогою" +
              " присвоєння. Використайте метод connect_to_database")
    ...
    def set_database_name(self, value):
        ...
        self.__database_name = self.__database_name.upper()
